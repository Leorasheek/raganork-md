...
const isVPS = !(__dirname.startsWith("/𝘿𝞢𝙁𝙏 𝞠𝞖𝞗𝞢𝞜𝞘𝞦") || __dirname.startsWith("/𝘿𝞢𝙁𝙏 𝞠𝞖𝞗𝞢𝞜𝞘𝞦"));
const isHeroku = __dirname.startsWith("/𝘿𝞢𝙁𝙏 𝞠𝞖𝞗𝞢𝞜𝞘𝞦");
...
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "https://i.imgur.com/dP4HYsK.jpeg Hey {sender}, 𝗜 𝗔𝗠 𝗔𝗟𝗜𝗩𝗘 \n Uptime: {uptime}",
    ...
    BOT_INFO: process.env.BOT_INFO || ' 🤍⃞𝄟ꪶʀᴏʟᴇx💃   ͢𝐒ᴇ͓ꪳʀ͎𖦻⃞🍓;𝘿𝞢𝙁𝙏 𝞠𝞖𝞗𝞢𝞜𝞘𝞦;0;https://i.imgur.com/dP4HYsK.jpeg',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "🤍⃞𝄟ꪶʀᴏʟᴇx💃   ͢𝐒ᴇ͓ꪳʀ͎𖦻⃞🍓,+917736962907",
    BOT_NAME: process.env.BOT_NAME || '𝘿𝞢𝙁𝙏 𝞠𝞖𝞗𝞢𝞜𝞘𝞦',
